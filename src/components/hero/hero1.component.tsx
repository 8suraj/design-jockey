...
export default function Hero1() {
	return (
		<section className='flex  justify-center '>
			<div className='w-11/12 bg-black2 backdrop-blur-xl rounded-xl p-8 h-full gap-12 flex flex-col  items-center || md:gap-4 md:p-6  md:justify-between md:items-start md:min-h-[12rem]	'>

		...
		<section className='py-4 md:py-10 '>
			<div className=' hero1 h-[100vh]  w-full  '>
				...
				<div className='w-full lg:w-[80vw] xl:w-[80vw] 2xl:w-[80vw] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-[100vh]  '>
					<div className=' w-full lg:w-fit  absolute   px-6 lg:p-8 lg:pr-0    -translate-x-1/2 lg:-translate-x-[100%]  -translate-y-1/2 top-[60%] left-[50%]  lg:left-[100%]   m2:top-[55%] m3:top-[50%] lg:top-[40%]  lg:-translate-y-1/4  '>
			...
			<div className='py-16 flex flex-col gap-8 px-6 md:px-14 sm:gap-16 md:gap-16 xl:px-4'>
